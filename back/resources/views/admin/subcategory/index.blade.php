...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="container">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="exampleInputFile" name="image" value="{{old('image')}}" required autofocus oninvalid="this.setCustomValidity('пожалуйста, заполните это поле')" oninput="this.setCustomValidity('')">
            ...
            {{-- Error Modal --}}
            <div class="container">
                <h3 class="text-center mb-4 mt-4">Подкатегория</h3>
