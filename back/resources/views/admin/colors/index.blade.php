...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="container">
                    ...
                    <div class="container">
                        <div class="container">
                            <form action="{{route('admin.color.store')}}" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="exampleInput" class="form-label">Категория</label>
                                    <input type="text" class="form-control col-6 @error('name') is-invalid @enderror" name="color" id="exampleInput" required autofocus oninvalid="this.setCustomValidity('пожалуйста, заполните это поле')" oninput="this.setCustomValidity('')">
                                </div>
            ...
            {{-- Error Modal --}}
            <div class="container">
                <h3 class="text-center mb-4 mt-4">Colors</h3>
